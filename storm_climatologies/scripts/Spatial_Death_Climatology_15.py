...
if __name__ == '__main__':
    ...
    for working_date_index in range(num_spc_dates):
        multiday_storm_object_table = get_storm_object_table(num_spc_dates, Death_Climatology, working_date_index)
        ...
        print('Total Storm Cells',len(place_holder))
...
#for those unique pieces of data in the storm object table, take the centroid of that piece of data
        centroids = utils.get_the_centroid(multiday_storm_object_table['polygon_object_latlng'], address_of_interest)
#The list of centroids is now the list of unique storm births in the indicated day index
       
        print('Total Storm Deaths:',len(centroids))
